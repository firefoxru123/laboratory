...
public class task15{
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        File file1 = new File("C:\\Users\\Hacker\\Desktop\\1 курс\\Информатика\\10 лаба\\t15_Uchastki.txt");
        FileReader fR1 = new FileReader(file1);
        BufferedReader file1_BR = new BufferedReader(fR1);
        File file2 = new File("C:\\Users\\Hacker\\Desktop\\1 курс\\Информатика\\10 лаба\\t15_Zaici_Volki.txt");
        FileReader fR2 = new FileReader(file2);
        BufferedReader file2_BR = new BufferedReader(fR2);
        File file3 = new File("C:\\Users\\Hacker\\Desktop\\1 курс\\Информатика\\10 лаба\\t15_Vodoemi.txt");
        FileReader fR3 = new FileReader(file3);
        BufferedReader file3_BR = new BufferedReader(fR3);
        File file4= new File("C:\\Users\\Hacker\\Desktop\\1 курс\\Информатика\\10 лаба\\t15_Itog.txt");
